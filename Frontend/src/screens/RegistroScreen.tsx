...
export default function RegistroScreen() {
    ...
    const { register: formRegister, handleSubmit, formState: { errors }, setError, watch } = useForm<FormData>({ 
        resolver: zodResolver(schema) 
    });
    
    const [showPassword, setShowPassword] = useState(false);
    const [showConfirmPassword, setShowConfirmPassword] = useState(false);
    const [securityQuestionSet, setSecurityQuestionSet] = useState<boolean>(false);
    ...
    const onSubmit = async (data: FormData) => {
        try {
            ...
            // Guardar el email para la pregunta secreta
            setUserEmail(data.email);
            setRegistrationSuccess(true);
            
            // No mostrar alerta aquí, pasamos al formulario de pregunta secreta
                        ...
                        {!securityQuestionSet ? (
                            <div className="security-question-section">
                                <div className="success-message">
                                    ...
                                    <p>Tu cuenta ha sido creada correctamente. Ahora configura tu pregunta secreta para mayor seguridad.</p>
                                </div>
                                <SecurityQuestionForm 
                                    email={userEmail}
                                    onQuestionSet={(success) => {
                                        setSecurityQuestionSet(success);
                                    }}
                                />
                            </div>
                        ) : (
                            <div className="registration-complete">
                                ...
                                <p>Tu cuenta ha sido creada y tu pregunta secreta configurada correctamente.</p>
