...
export const carritoAPI = {
  ...
  crearPedido: async (data: { direccion_envio: string; notas_cliente?: string; metodo_pago_id: number; tipo_entrega?: string; costo_envio?: number; direccion_data?: { calle: string; numero: string; colonia: string; ciudad: string; estado_dir: string; codigo_postal: string; texto_completo: string } | null }) => {
